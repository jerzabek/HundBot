package ga.jarza.hundbot.main.db;

import ga.jarza.hundbot.exceptions.InvalidMemeException;
import ga.jarza.hundbot.exceptions.InvalidWarningException;
import ga.jarza.hundbot.main.commands.ChatCommands;
import ga.jarza.hundbot.main.MainBot;
import ga.jarza.hundbot.main.UserPremiumObject;
import ga.jarza.hundbot.main.Util;
import ga.jarza.hundbot.main.commands.memes.Meme;
import ga.jarza.hundbot.main.commands.moderation.Permission;
import ga.jarza.hundbot.main.commands.moderation.Setting;
import ga.jarza.hundbot.main.commands.moderation.Warning;
...
public class DataManager {
  ...
  public final static String CONFIG = "src/main/resources/config.json",
          SETTINGS = "src/main/resources/settings.json",
          MEMES = "src/main/resources/memes.json",
          WARNS = "src/main/resources/warnings.json",
          GLMEMES = "src/main/resources/globalmemes.json",
          PREMIUMS = "src/main/resources/premiumusers.json";
  ...
  public static void finish() {
    try {
      ...
      try {
        ...
        fw.flush();
        fw.close();
        fw = new FileWriter(DataManager.CONFIG);
