...
public class Setting {
  ...
  public static final String KICKP = "kw", BANP = "bw", MODR = "mr", WARNR = "wr", PINCHAN = "pc",
    SETTINGSF = "settings", PERMSF = "perms", BOTCHAN = "botchan", CHANID="channelid",
  EXCP = "ga/jarza/hundbot/exceptions", PREMIUM = "premium", LOGGINGCHANNEL = "logchan";
